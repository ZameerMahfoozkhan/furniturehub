    ...
    <footer className="footer">
      <div className="footer__divider">
        <svg viewBox="0 0 1440 40" preserveAspectRatio="none" fill="none">
          <path d="M0 20C240 8 480 32 720 20C960 8 1200 32 1440 20V40H0V20Z" fill="var(--color-accent)" opacity="0.08" />
          <path d="M0 28C240 16 480 36 720 28C960 16 1200 36 1440 28V40H0V28Z" fill="var(--color-accent)" opacity="0.04" />
        </svg>
      </div>
      ...
      <div className="footer__inner container">
        <div className="footer__grid">
          ...
          <div className="footer__brand">
            <Link to="/" className="footer__logo font-serif">{BRAND_NAME}</Link>
            <p className="footer__blurb">
              Rooted in the timeless craftsmanship of Ayodhya, we bring handcrafted solid wood furniture
              and smart, affordable engineered wood pieces to homes across India. Every piece tells a story
          ...
          <div className="footer__contact">
            <h4 className="footer__heading eyebrow">Get in Touch</h4>
            <ul className="footer__contact-list">
              ...
              <li className="footer__location">
                ...
                <strong>Shipping Pan India</strong>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="footer__bottom">
          ...
          <p>Handcrafted with ♥ in Ayodhya by <a href="https://zameerkhan.online" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--color-accent)', textDecoration: 'none' }}>Zameer Mahfooz Khan</a></p>
        </div>
      </div>
    </footer>
  );
